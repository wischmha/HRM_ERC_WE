...
```{r population_distribution}
  ...
  plot_pdf_png("Figure_S2", aspect_ratio = 1.2,
    ...
    ggplot(aes(xmin = long_min, xmax = long_max, ymin = lat_min, ymax = lat_max, fill = pop)) +
      ...
      geom_rect() +
      labs(y = "© Eurostat, EFGS, for the populations density grid",
...
```{r daily_mean_temperature_eobs}
  ...
  plot_pdf_png("Figure_S3", aspect_ratio = 1.0,
    consecutive_days_25 %>%
...
```{r temperature_plots}
  ...
  plot_pdf_png("Figure_S4", aspect_ratio = 0.5,
    ...
    ggplot() +
      ...
      labs(x = "© EuroGeographics for the administrative boundaries, © E-OBS for the temperature data") +
