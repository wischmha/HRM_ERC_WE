...
date:   "Written: 2023-04-12 to 2023-08-31 / Totally revised: 2024-11-07 to 2024-12-01 / Executed: `r Sys.Date()`"
...
```{r fit_common_loading_models}
  ...
  plot_pdf_png("Figure_5", aspect_ratio = 0.7,
    ...
    ggplot() +
      ...
      labs(fill = "Scale", y = "", x = "© EuroGeographics for the administrative boundaries") +
  ...
  plot_pdf_png("Figure_6", aspect_ratio = 0.7,
    ...
    ggplot() +
      ...
      labs(fill = "Annual\nScale\nChange\n[1/year]", y = "", x = "© EuroGeographics for the administrative boundaries") +
      std_theme() + theme(legend.position = "right", legend.text = element_text(hjust = 1)) + facet_grid(vars(sex), vars(age)))
