...
date:   "Written: 2023-04-12 to 2023-08-31 / Totally revised: 2024-11-07 to 2025-04-06 / Executed: `r Sys.Date()`"
...
```{r population_distribution}
  ...
  # clean up memory (make room for temperture data)
  gc(full = TRUE)
  stopImplicitCluster()
```
...
```{r fit_individual_GAMs}
  ...
  plot_pdf_png("Figure_X7", aspect_ratio = 0.5,
    ...
    ggplot() +
      ...
      geom_sf(inherit.aes = FALSE, aes(), linewidth = 0.05, color = "black", fill = NA) +
      std_theme() + theme(legend.position = "right") + facet_grid(vars(sex), vars(age)))
  print(sprintf("Figure_X7: Minima of Heat-Related Risk, for %d, Regression Fit across Years", LOADS_YEAR))
